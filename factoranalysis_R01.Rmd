...
df<- read.csv("csvs/df_nosubj.csv")
...
# re-order dataframe
#df_norm <- df_norm[, c("PCAccuracy","MausQs","MausFR","AM","Dependency","Lure")] 

#1) All columns
#df_norm <- df_norm[, c("PCAccuracy",'LocAniLink','AniObjLink','AniLocLink','ObjAniLink','LocObjLink','ObjLocLink',"Target",'PSObjTarget','PSLocTarget','PSAniTarget',"MausQs","MausFR","AM",'AM_parent','AM_exp','Raw.KBIT','KBit_Score','Age..months.','demo_child_gender',"Dependency","Foil",'PSObjFoil','PSLocFoil','PSAniFoil',"Lure",'PSObjLure','PSLocLure','PSAniLure')] 
# 1.1) All columns except dependency, age, gender:
#1) All columns
#df_norm <- df_norm[, c("PCAccuracy",'LocAniLink','AniObjLink','AniLocLink','ObjAniLink','LocObjLink','ObjLocLink',"Target",'PSObjTarget','PSLocTarget','PSAniTarget',"MausQs","MausFR","AM",'AM_parent','AM_exp','Raw.KBIT','KBit_Score',"Foil",'PSObjFoil','PSLocFoil','PSAniFoil',"Lure",'PSObjLure','PSLocLure','PSAniLure')]
#2) Eliminating some highly correlated columns (Sub-PCs and PSs, and Sub-AMs):
#df_norm <- df_norm[, c("PCAccuracy","Target","MausQs","MausFR","AM",'Raw.KBIT','KBit_Score','Age..months.','demo_child_gender',"Dependency","Foil","Lure")]
#3) Eliminating MORE highly correlated columns (Foil, Target, Age):
#df_norm <- df_norm[, c("PCAccuracy","MausQs","MausFR","AM",'Raw.KBIT','KBit_Score','demo_child_gender',"Dependency","Lure")]
# v.2)
df_norm <- df_norm[, c("PCAccuracy","Target","MausQs","MausFR","AM","Dependency","Foil","Lure")]
df_norm <- df_norm[, c("PCAccuracy","Target","MausQs","MausFR","AM","Foil","Lure")]

#df_norm <- df_norm[, c("PCAccuracy","Target","MausQs","MausFR","AM","Dependency","Foil","Lure",'PSObjLure','PSLocLure','PSAniLure')] 
#df_norm <- df_norm[, c("PCAccuracy",'LocAniLink','AniObjLink','AniLocLink','ObjAniLink','LocObjLink','ObjLocLink',"Target",'PSObjTarget','PSLocTarget','PSAniTarget')]
#df_norm <- df_norm[, c("PCAccuracy","MausQs","MausFR","AM","Dependency","Lure",'PSLocLure')] 
...
pc_load <- pca_sum3[[3]]$loadings #get factor loadings for the factor congruence analysis
