...
#df_norm <- df_norm[, c("PCAccuracy",'LocAniLink','AniObjLink','AniLocLink','ObjAniLink','LocObjLink','ObjLocLink',"Target",'PSObjTarget','PSLocTarget','PSAniTarget',"MausQs","MausFR","AM","Dependency","Foil",'PSObjFoil','PSLocFoil','PSAniFoil',"Lure",'PSObjLure','PSLocLure','PSAniLure')] 
...
#change df name in pca_est function before running the rest!!!!
...
#younger child
factor.congruence(yc_load$TC1, yc_load$TC2,digits=3,use="complete",structure=FALSE)

#older child
factor.congruence(oc_load$TC1, oc_load$TC2,digits=3,use="complete",structure=FALSE)

#adults
factor.congruence(adult_load$TC1, adult_load$TC2,digits=3,use="complete",structure=FALSE)
```
...
#younger vs older
fa.congruence(yc_load$TC1, oc_load$TC1,digits=3,use="complete",structure=FALSE)

#older vs adult
fa.congruence(oc_load$TC1, adult_load$TC1,digits=3,use="complete",structure=FALSE)

#younger vs adult
fa.congruence(yc_load$TC1, adult_load$TC1,digits=3,use="complete",structure=FALSE)
```
...
#younger vs older
fa.congruence(yc_load$TC2, oc_load$TC2,digits=3,use="complete",structure=FALSE)

#older vs adult
fa.congruence(oc_load$TC2, adult_load$TC2,digits=3,use="complete",structure=FALSE) 

#younger vs adult
fa.congruence(yc_load$TC2, adult_load$TC2,digits=3,use="complete",structure=FALSE)
```
